...
namespace Bug_Tracker.Controllers
{
    public class TicketAttachmentsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,TicketId,FilePath,Description,UserId,FilePath")] TicketAttachment ticketAttachment, HttpPostedFileBase newAttachment)
        {
            if (ModelState.IsValid)
            {
                if (newAttachment != null)
                {
                    ...
                    var fileName = Path.GetFileName(newAttachment.FileName);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,TicketId,FilePath,Description,UserId,FileUrl,Created")] TicketAttachment ticketAttachment)
        {
            if (ModelState.IsValid)
            {
