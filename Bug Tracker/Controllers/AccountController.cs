...
namespace Bug_Tracker.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            if (User == null)
            {
                TempData["UnconfirmedEmailError"] = "Email Not Found";
                return RedirectToAction("Login", "Account");
            }
            if (!User.EmailConfirmed)
            {
                return View(); // Needs to point to verify email when the time comes
            }
        ...
        public async Task<ActionResult> Register(ExtendedRegisterViewModel model)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    try
                    {
                        roleHelper.AddUserToRole(user.Id, "NewUser");
        ...
        public async Task<ActionResult> ForgotPassword(ForgotPasswordViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                {
                    Subject = "Reset Email",
                    Body = $"Please click to reset your password <a href=\"{callbackUrl}\">here</a>",
                    IsBodyHtml = true
                };
        ...
        // GET: /Resending Email Confirmation
        ...
        // POST: /Resending Email Confirmaion
